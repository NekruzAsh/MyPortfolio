      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2 ">
          ...
          <p className="py-2 text-[#7899BD]">
            ...
            new technologies and apply them to my projects. Currently, I am
            learning more about <span className="text-[#f44336]">developing web applications</span> using different
            frameworks and libraries. During my free time, I'm{" "}
